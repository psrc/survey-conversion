...
tours_schema = pa.DataFrameSchema(
    {
        ...
        "tour_weight": Column(int, nullable=False),
...
trips_schema = pa.DataFrameSchema(
    {
        ...
        "trip_weight_original": Column(int, nullable=False),
...
household_schema = pa.DataFrameSchema(
    {
        ...
        "hh_weight_original": Column(float, nullable=False),
...
person_schema = pa.DataFrameSchema(
    {
        ...
        "person_weight_original": Column(float, nullable=False),
